...
//    	}
	...
	private boolean tipoOperacaoValida(Long operacao) {
		if (operacao != TipoOperacaoEnum.LIQUIDACAO_ANTECIPADA.getId()) {
			// throw new LiquidacaoContratoServiceException(ERRO_TIPO_OPERACAO + " Tpo de
			// operação enviada: "+operacao+". Tipo de operação esperada:
			// "+TipoOperacaoEnum.LIQUIDACAO_ANTECIPADA + ".");
		}
		return true;
	}
